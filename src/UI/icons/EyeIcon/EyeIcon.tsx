import { IEyeIcon } from "@/types/components"
import { FC } from "react"

const EyeIcon: FC<IEyeIcon> = ({ setIsVisible, className }) => {
  const onIconClick = () => setIsVisible(prev => !prev)
