...
import { Wrapper, Title, WrapCategory, Wrap, Figcaption, Figure } from "./HomePageMainBlock.styled";
  ...
  return (
    <Wrapper>
      ...
      <WrapCategory>
        <Wrap>
          <Figure>
            <svg width="68" height="68" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Figure>
            <svg width="68" height="68" viewBox="0 0 161 160" fill="none" xmlns="http://www.w3.org/2000/svg">
